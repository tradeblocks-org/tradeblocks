...
What this does and does not cover, stated plainly: it governs the thresholds this
tool derives from your configuration. It makes no change to the P&L path itself,
which arrives already computed, and it does not alter how P&L figures are
reported.
