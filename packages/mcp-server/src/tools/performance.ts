...
import {
  ...
  buildRealizedDrawdownSeries as buildDrawdownSeries,
  buildRealizedMonthlyReturnsByCloseDate as buildMonthlyReturns,
  buildRealizedMonthlyReturnPercentByCloseDate as buildMonthlyReturnsPercent,
  buildRealizedTradePlDistribution as buildReturnDistribution,
  buildRealizedWeekdayDataByCloseDate as buildDayOfWeekData,
  buildRealizedTradeSequenceByCloseDate as buildTradeSequence,
  buildRealizedRomTimelineByCloseDate as buildRomTimeline,
  buildRealizedRollingMetricsByCloseDate as buildRollingMetrics,
  buildRealizedExitReasonBreakdown as buildExitReasonBreakdown,
  ...
  server.registerTool(
    ...
    async ({ blockId, strategy, period, year, dateRange, normalizeTo1Lot }) => {
      try {
        ...
        const { periods, totals } = buildRealizedPeriodReturnsByCloseDate(trades, period);
